        ...
        <div className='w-full h-full'>
          <div className='h-full w-[50%] flex flex-col justify-center items-center m-auto'>
            <div className="form-header-container text-center">
              <h1 className="heading3 text-4xl font-bold">Welcome Back!</h1>
              <span className="subHeading3 text-gray-500 text-bold"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius, itaque!</span>
            </div>
            ...
            <div className='m-5'>
              <p className='select-none'>Don't have an account? <span className='select-none text-colorSecondary cursor-pointer'>Signup</span></p>
            </div>
          </div>
        </div>
      </div>
